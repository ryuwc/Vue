    ...
    >
      ...
      <div class="w-5/6 mx-auto " v-for="todo in todoList" :key="todo.id">
        <div id="border" class="flex items-center justify-between my-2 rounded-lg">
          ...
          <div v-if="todo.isImportant" @click="toggleImportant(todo)" class="mr-2">
            <i style="color: goldenrod;" class="ml-auto fa-solid fa-star"></i>
          </div>
          <div v-else class="mr-2">
            <i style="color: goldenrod;" @click="toggleImportant(todo)" class="pl-auto fa-regular fa-star"></i>
          </div>
        </div>
      </div>
    </div>
